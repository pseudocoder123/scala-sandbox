...
final case class SensorReading(
    ...
    def companion: caseStudy1.protobuf.SensorReading.SensorReading.type = caseStudy1.protobuf.SensorReading.SensorReading
    // @@protoc_insertion_point(GeneratedMessage[caseStudy1.protobuf.SensorReading])
}

object SensorReading extends scalapb.GeneratedMessageCompanion[caseStudy1.protobuf.SensorReading.SensorReading] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[caseStudy1.protobuf.SensorReading.SensorReading] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): caseStudy1.protobuf.SensorReading.SensorReading = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[caseStudy1.protobuf.SensorReading.SensorReading] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = caseStudy1.protobuf.SensorReading.SensorReading(
    sensorId = 0,
    timestamp = 0L,
    temperature = 0.0f,
    humidity = 0.0f
  )
  implicit class SensorReadingLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, caseStudy1.protobuf.SensorReading.SensorReading]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, caseStudy1.protobuf.SensorReading.SensorReading](_l) {
  ...
  ): _root_.caseStudy1.protobuf.SensorReading.SensorReading = _root_.caseStudy1.protobuf.SensorReading.SensorReading(
    sensorId,
    timestamp,
    temperature,
    humidity
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[caseStudy1.protobuf.SensorReading])
}
